...
class BaseBuild {
    ...
    print(context, filter, globalContext) {
        return this.getPrintTemplate().then(printTemplateHtml => {
            var printTemplate;

            console.log('printTemplateHtml', printTemplateHtml);
            console.log('this.redactor.getTemplateEngine()', this.redactor.getTemplateEngine());
