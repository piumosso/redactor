define('redactor/core/Build', [
...
], function(config, BlockCollection, getBlock, templates, initializeMixin){
    ...
    Build.prototype._templateGetter = function(template, templateSource, defaultTemplate, defaultTemplateSource){
        ...
        if (template) {
            ...
            require(['redactor/vendors/text!' + templateSource], function(template){
                df.resolve(template);
            });
        } else if (defaultTemplate) {
            df.resolve(defaultTemplate);
        } else if (defaultTemplateSource) {
            require(['redactor/vendors/text!' + defaultTemplateSource], function(template){
                df.resolve(template);
            });
        } else {
