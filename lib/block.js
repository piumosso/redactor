...
class BaseBlock {
  ...
  static get component() {
    return React.createClass({
      render() {
        return React.createElement('article', {className: 'redactor-block'},
          React.createElement(this.props.formComponent, {model: this.props.model}),
          React.createElement('div', {className: 'redactor-block__handler'})
        );
      }
    });
  }
