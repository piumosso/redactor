...
class BaseBuild {
      ...
      render: () => {
        return React.createElement('section', {className: 'redactor-build'},
          React.createElement('div', {className: 'redactor-build__form'},
            React.createElement(this.formComponent, {form: this.form})
          ),
          React.createElement('div', {className: 'redactor-build__blocks'},
            React.createElement(this.blocks.component, {blocks: this.blocks})
          )
        );
      }
    });
  ...
  attach(domElement) {
    React.render(React.createElement(this.component, {}), domElement);
  }
}
